...
export default async function Home() {
  ...
  const page = pages[0]
  return (
    <main className="min-h-screen" style={{ background: '#F8F5ED' }}>
      <div className="max-w-6xl mx-auto px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-7xl font-bold mb-8" style={{ fontFamily: 'var(--font-playfair)', color: '#6B5D4F' }}>
            Our Stories
          </h1>
          <p className="text-2xl max-w-4xl mx-auto leading-relaxed" style={{ fontFamily: 'var(--font-raleway)', color: '#9D7A6B' }}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Coming Soon Cards */}
          <div className="rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden" style={{ background: '#F8F5ED', border: '2px solid #F8B4CB' }}>
            <div className="aspect-video flex items-center justify-center" style={{ background: 'linear-gradient(to bottom right, #F8B4CB, #F0C8B9)' }}>
              <div className="text-center">
                <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-md" style={{ background: '#F8F5ED' }}>
          ...
          <div className="rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden" style={{ background: '#F8F5ED', border: '2px solid #F0C8B9' }}>
          ...
          <div className="rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden" style={{ background: '#F8F5ED', border: '2px solid #F7D78B' }}>
        ...
        <div className="text-center mt-16">
          <p className="text-lg mb-8" style={{ fontFamily: 'var(--font-raleway)', color: '#9D7A6B' }}>
