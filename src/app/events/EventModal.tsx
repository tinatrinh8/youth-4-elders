  ...
  return (
    ...
    >
      ...
      >
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2 mb-3">
                <span
                  ...
                  style={{ background: getEventColor(event.type), color: 'var(--color-cream)', fontFamily: 'var(--font-kollektif)' }}
                >
        ...
        <div className="p-6 md:p-8" style={{ background: getEventTint(event.type) }}>
          <div className="flex flex-wrap gap-4 mb-6">
            {getTimeFromDescription(event.description) && (
            ...
            {getLocationFromDescription(event.description) && (
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl" style={{ background: 'rgba(234, 225, 203, 0.7)' }}>
                <svg className="w-4 h-4" style={{ color: 'var(--color-brown-medium)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
